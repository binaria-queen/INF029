...
#include "JaquelineCosta20212160025.h" // Substitua pelo seu arquivo de header renomeado
#include <stdio.h>
#include <stdlib.h>
...
int validacao_data(DataQuebrada data) {
  ...
  if ((biss > 0) && (data.iDia > 0) && (data.iDia < 30) && (data.iMes == 2)) {
    cont = cont + 1;
  } else if ((biss == 0) && (data.iDia > 0) && (data.iDia < 29) &&
             (data.iMes == 2)) {
    cont = cont + 1;
  }
  return cont;
...
DiasMesesAnos q2(char datainicial[], char datafinal[]) {
  ...
  // (datainicial > datafinal)
    ...
    return dma;
             ...
             (dataQuebradaf.iMes < dataQuebradai.iMes)) {
    dma.retorno = 4;
    return dma;
  } else if ((dataQuebradaf.iAno == dataQuebradai.iAno) &&
             (dataQuebradaf.iMes == dataQuebradai.iMes) &&
             (dataQuebradaf.iDia < dataQuebradai.iDia)) {
    dma.retorno = 4;
    return dma;
  }

  else {
    while ((dataQuebradaf.iDia != dataQuebradainicial.iDia) ||
           (dataQuebradaf.iMes != dataQuebradainicial.iMes) ||
           (dataQuebradaf.iAno != dataQuebradainicial.iAno)) {
      // printf("anos %d\n", dma.qtdAnos);

      if (((dataQuebradaf.iDia >= dataQuebradainicial.iDia) &&
           (dataQuebradaf.iMes >= dataQuebradainicial.iMes) &&
           (dataQuebradaf.iAno > dataQuebradainicial.iAno)) ||
          (dataQuebradaf.iAno > dataQuebradainicial.iAno + 1)) {
        ...
        if ((dataQuebradainicial.iMes == 1) ||
            (dataQuebradainicial.iMes == 3) ||
            (dataQuebradainicial.iMes == 5) ||
            (dataQuebradainicial.iMes == 7) ||
            (dataQuebradainicial.iMes == 8) ||
            (dataQuebradainicial.iMes == 10) ||
            (dataQuebradainicial.iMes == 12)) {
          dma.qtdDias = dma.qtdDias + 1;
        ...
        if ((dataQuebradaf.iMes == 1) || (dataQuebradaf.iMes == 3) ||
            (dataQuebradaf.iMes == 5) || (dataQuebradaf.iMes == 7) ||
            (dataQuebradaf.iMes == 8) || (dataQuebradaf.iMes == 10) ||
            (dataQuebradaf.iMes == 12)) {
          dma.qtdDias = dma.qtdDias - 1;
        }
        ...
        if (dataQuebradainicial.iMes < dataQuebradaf.iMes - 1) {
          ...
          } else if ((dataQuebradainicial.iMes == 1) ||
                     (dataQuebradainicial.iMes == 3) ||
                     (dataQuebradainicial.iMes == 5) ||
                     (dataQuebradainicial.iMes == 7) ||
                     (dataQuebradainicial.iMes == 8) ||
...
int biss(DataQuebrada dataQuebradainicial) {
  ...
  if (dataQuebradainicial.iAno % 4 == 0) {
    biss = biss + 1;
  } else if ((dataQuebradainicial.iAno % 4 == 0) &&
             (dataQuebradainicial.iAno % 100 == 0)) {
    biss = 0;
  } else if ((dataQuebradainicial.iAno % 4 == 0) &&
             (dataQuebradainicial.iAno % 100 == 0) &&
             (dataQuebradainicial.iAno % 400 == 0)) {
    biss = biss + 1;
  }
  if ((biss > 0) && (dataQuebradainicial.iDia > 0) &&
      (dataQuebradainicial.iDia < 30) && (dataQuebradainicial.iMes == 2)) {
    cont = cont + 1;
  } else if ((biss == 0) && (dataQuebradainicial.iDia > 0) &&
             (dataQuebradainicial.iDia < 29) &&
             (dataQuebradainicial.iMes == 2)) {
    cont = cont + 1;
  }
  return cont;
}
